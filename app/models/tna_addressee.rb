class TnaAddressee < ActiveFedora::Base
  include RdfType
  include AssignId
  ...
  def add_rdf_types_p
    ['http://dlib.york.ac.uk/ontologies/tna#Addressee', 'http://xmlns.com/foaf/0.1/Person', 'http://dlib.york.ac.uk/ontologies/tna#All']
  end

  def add_rdf_types_g
    ['http://dlib.york.ac.uk/ontologies/tna#Addressee', 'http://xmlns.com/foaf/0.1/Group', 'http://dlib.york.ac.uk/ontologies/tna#All']
  end
