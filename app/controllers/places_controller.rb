class PlacesController < ApplicationController
  ...
  def index
    ...
    if params[:unlock].nil? #or params[:unlock][:auth] != 'deep' or params[:unlock][:auth] != 'os'
      ...
      SolrQuery.new.solr_query(q='has_model_ssim:Place', fl='id, place_name_tesim, parent_ADM4_tesim, parent_ADM3_tesim, parent_ADM2_tesim, parent_ADM1_tesim', rows=5000, sort='preflabel_si asc')['response']['docs'].map.each do |result|
