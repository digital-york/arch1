    ...
    module ExcelHelper
        ...
        def self.parse_borthwick_spreadsheet(filename)
            ...
            entries.each_with_index { |entry, index|
                ...
                entry_row.image_id              = entry[35]
                entry_row.group1_as_written     = entry[36]
                entry_row.group1_person_or      = entry[37]
                entry_row.group1_group          = entry[38]
                entry_row.group1_gender         = entry[39]
                entry_row.group1_person_role    = entry[40]
                entry_row.group1_descriptor     = entry[41]
                entry_row.group1_note           = entry[42]
                entry_row.group2_as_written     = entry[43]
                entry_row.group2_person_or      = entry[44]
                entry_row.group2_group          = entry[45]
                entry_row.group2_gender         = entry[46]
                entry_row.group2_person_role    = entry[47]
                entry_row.group2_descriptor     = entry[48]
                entry_row.group2_note           = entry[49]
                entry_row.person1_as_written    = entry[50]
                entry_row.person1_person_group  = entry[51]
                entry_row.person1_people_name   = entry[52]
                entry_row.person1_gender        = entry[53]
                entry_row.person1_person_role   = entry[54]
                entry_row.person1_descriptor    = entry[55]
                entry_row.person1_note          = entry[56]
                entry_row.person2_as_written    = entry[57]
                entry_row.person2_person_group  = entry[58]
                entry_row.person2_people_name   = entry[59]
                entry_row.person2_gender        = entry[60]
                entry_row.person2_person_role   = entry[61]
                entry_row.person2_descriptor    = entry[62]
                entry_row.person2_note          = entry[63]
                entry_row.person3_as_written    = entry[64]
                entry_row.person3_person_group  = entry[65]
                entry_row.person3_people_name   = entry[66]
                entry_row.person3_gender        = entry[67]
                entry_row.person3_person_role   = entry[68]
                entry_row.person3_descriptor    = entry[69]
                entry_row.person3_note          = entry[70]
