Rails.application.configure do
  ...
  # *** Changed this to false otherwise exception occurs (py) ***
  ...
  # *** Commented this out otherwise trouble getting images (py) ***
  ...
  # *** Changed this to true otherwise some of the images do not appear (py) ***
