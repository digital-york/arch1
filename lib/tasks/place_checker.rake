...
namespace :place_checker do
    ...
    task check: :environment do
        ...
        response = SolrQuery.new.solr_query('inScheme_ssim:nc580m66v',
                                            fl="id,preflabel_tesim,countrycode,place_name_tesim,parent_ADM1_tesim,parent_ADM2_tesim,parent_ADM3_tesim,parent_ADM4_tesim",
        ...
        CSV.open("log/places.csv", "w") do |csv|
            csv << ["ID","parent_adm1","parent_adm2","parent_adm3","parent_adm4","Label"]
