...
=end
  ...
  task e: :environment do
    ...
    r.ordered_folio_proxies.insert_target_at Folio.find("sf268649s")
    r.ordered_folio_proxies.insert_target_at Folio.find("np193b36b")
    r.ordered_folio_proxies.insert_target_at Folio.find("ms35t9936")
    r.ordered_folio_proxies.insert_target_at Folio.find("kw52j9675")
    r.ordered_folio_proxies.insert_target_at Folio.find("st74cr714")
    r.ordered_folio_proxies.insert_target_at Folio.find("dj52w6133")
    r.ordered_folio_proxies.insert_target_at Folio.find("ws859h04r")
    r.ordered_folio_proxies.insert_target_at Folio.find("b8515p88p")
    r.ordered_folio_proxies.insert_target_at Folio.find("4f16c416k")
    r.ordered_folio_proxies.insert_target_at Folio.find("dr26xz81m")
    r.ordered_folio_proxies.insert_target_at Folio.find("9w0324469")
    r.ordered_folio_proxies.insert_target_at Folio.find("8p58pf22f")
    r.ordered_folio_proxies.insert_target_at Folio.find("t148fj484")
    r.ordered_folio_proxies.insert_target_at Folio.find("gt54kp407")
    r.ordered_folio_proxies.insert_target_at Folio.find("ff3656776")
    r.ordered_folio_proxies.insert_target_at Folio.find("wd375x89v")
    r.ordered_folio_proxies.insert_target_at Folio.find("mg74qn657")
    r.ordered_folio_proxies.insert_target_at Folio.find("ns0647384")
    r.ordered_folio_proxies.insert_target_at Folio.find("dj52w614c")
    r.ordered_folio_proxies.insert_target_at Folio.find("c247dt504")
    r.ordered_folio_proxies.insert_target_at Folio.find("fj2363519")
    r.ordered_folio_proxies.insert_target_at Folio.find("4b29b742z")
    r.ordered_folio_proxies.insert_target_at Folio.find("pz50gx560")
    r.ordered_folio_proxies.insert_target_at Folio.find("1831cm31n")
    r.ordered_folio_proxies.insert_target_at Folio.find("m039k642v")
    r.ordered_folio_proxies.insert_target_at Folio.find("r494vm54v")
    r.ordered_folio_proxies.insert_target_at Folio.find("9593tw88n")
    r.ordered_folio_proxies.insert_target_at Folio.find("d217qq72t")
    r.ordered_folio_proxies.insert_target_at Folio.find("6969z240w")
    r.ordered_folio_proxies.insert_target_at Folio.find("g158bj64r")
    r.ordered_folio_proxies.insert_target_at Folio.find("mg74qn66h")
    r.ordered_folio_proxies.insert_target_at Folio.find("vh53ww87j")
    r.ordered_folio_proxies.insert_target_at Folio.find("bk128c38g")
    r.ordered_folio_proxies.insert_target_at Folio.find("6108vc769")
    r.ordered_folio_proxies.insert_target_at Folio.find("0z708x670")
    r.ordered_folio_proxies.insert_target_at Folio.find("6682x539m")
    r.ordered_folio_proxies.insert_target_at Folio.find("nc580p18m")
    r.ordered_folio_proxies.insert_target_at Folio.find("w3763825p")
    r.ordered_folio_proxies.insert_target_at Folio.find("xg94hr090")
    r.ordered_folio_proxies.insert_target_at Folio.find("v692t7818")
    r.ordered_folio_proxies.insert_target_at Folio.find("tx31qk190")
    r.ordered_folio_proxies.insert_target_at Folio.find("4m90dw79x")
    r.ordered_folio_proxies.insert_target_at Folio.find("r207tq95w")
    r.ordered_folio_proxies.insert_target_at Folio.find("2n49t3101")
    r.ordered_folio_proxies.insert_target_at Folio.find("pg15bg380")
    r.ordered_folio_proxies.insert_target_at Folio.find("9w032448v")
    r.ordered_folio_proxies.insert_target_at Folio.find("xk81jm94t")
    r.ordered_folio_proxies.insert_target_at Folio.find("fj236352k")
    r.ordered_folio_proxies.insert_target_at Folio.find("9z9031368")
    r.ordered_folio_proxies.insert_target_at Folio.find("cf95jc78t")
    r.ordered_folio_proxies.insert_target_at Folio.find("6h440t846")
    r.ordered_folio_proxies.insert_target_at Folio.find("fb494979h")
    r.ordered_folio_proxies.insert_target_at Folio.find("4b29b7437")
    r.ordered_folio_proxies.insert_target_at Folio.find("5425kb965")
    r.ordered_folio_proxies.insert_target_at Folio.find("pg15bg398")
    r.ordered_folio_proxies.insert_target_at Folio.find("hd76s1380")
    r.ordered_folio_proxies.insert_target_at Folio.find("8s45qb514")
    r.ordered_folio_proxies.insert_target_at Folio.find("8w32r716s")
    r.ordered_folio_proxies.insert_target_at Folio.find("jq085m32z")
    r.ordered_folio_proxies.insert_target_at Folio.find("pn89d8080")
    r.ordered_folio_proxies.insert_target_at Folio.find("v405sb64d")
    r.ordered_folio_proxies.insert_target_at Folio.find("736665815")
    r.ordered_folio_proxies.insert_target_at Folio.find("6682x540c")
    r.ordered_folio_proxies.insert_target_at Folio.find("zk51vj05s")
    r.ordered_folio_proxies.insert_target_at Folio.find("3f462675w")
    r.ordered_folio_proxies.insert_target_at Folio.find("jw827d161")
    r.ordered_folio_proxies.insert_target_at Folio.find("js956h06j")
    r.ordered_folio_proxies.insert_target_at Folio.find("h128ng20j")
    r.ordered_folio_proxies.insert_target_at Folio.find("2b88qd518")
    r.ordered_folio_proxies.insert_target_at Folio.find("tt44pp28q")
    r.ordered_folio_proxies.insert_target_at Folio.find("bv73c201s")
    r.save
  end
  ...
  def delete_create_folio(num,title,reg)
    ...
    fol = Folio.new
    reg.ordered_folio_proxies.insert_target_at_at(num,fol)
    reg.save
